...
viptime = 100
ALLOWED_GROUP_ID = -4727326826   # ID BOX
admin_diggory = "PhucModder" # ví dụ : để user name admin là @diggory347 bỏ dấu @ đi là đc
name_bot = "PhucModder Bot"
zalo = "0782984967"
web = ""
facebook = "no"
allowed_group_id = -4727326826 # ID BOX
...
share_log = []
tool = ''
BOT_LINK = 'https://t.me/ZingAutoRegBot'
TOKEN = '7842461337:AAFEL8Rjul_lUST2h1mlDpSPp7hiVzWg0CE'  
bot = TeleBot(TOKEN)
